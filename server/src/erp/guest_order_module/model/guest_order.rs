...
use crate::{
    erp::{
        order_module::model::{CheckOrderResult, Order, OrderCurrency, OrderItem, OrderType},
        util::{eq_or_not, get_sort_col_str, get_sorter_str, in_or_not, like_or_not},
    },
    myhelper::set_to_string,
};

#[derive(Debug, Serialize, Deserialize, ToSchema, AsRefStr, Type)]
...
impl From<GuestOrder> for Order {
    fn from(value: GuestOrder) -> Self {
        ...
        Order {
            ...
            order_payment_status: crate::erp::order_module::model::OrderPaymentStatus::None,
